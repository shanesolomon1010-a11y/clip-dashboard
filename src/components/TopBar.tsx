...
export default function TopBar({ title, postCount }: Props) {
  ...
  return (
    <header className="h-14 shrink-0 bg-[var(--bg-base)] border-b border-[rgba(247,231,206,0.06)] flex items-center gap-4 px-6">
      {/* Page title */}
          ...
          <button
            ...
            className={`px-2.5 py-1 rounded-lg text-[11px] font-semibold transition-all ${
              dateRange === value
                ...
                : 'text-[var(--text-3)] hover:text-[var(--text-2)] hover:bg-[rgba(247,231,206,0.04)]'
            }`}
          >
            {label}
          </button>
      ...
      <select
        ...
        className="bg-[rgba(247,231,206,0.04)] border border-[rgba(247,231,206,0.08)] rounded-lg text-[11px] text-[var(--text-2)] px-2.5 py-1 outline-none hover:border-[rgba(247,231,206,0.14)] focus:border-[rgba(247,231,206,0.18)] transition-colors cursor-pointer"
      >
