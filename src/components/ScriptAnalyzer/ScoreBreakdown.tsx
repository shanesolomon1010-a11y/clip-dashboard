...
export default function ScoreBreakdown({ data, color }: Props) {
  return (
    <div className="mt-3 pt-4 border-t border-white/[0.06] space-y-4">
      {/* Sub-score bars */}
      ...
      <div className="space-y-2">
        <div className="flex gap-2">
          <span className="text-[11px] font-semibold text-emerald-400 shrink-0">Top Strength:</span>
          <span className="text-[11px] text-[var(--text-2)] leading-relaxed">{data.topStrength}</span>
        </div>
        <div className="flex gap-2">
          <span className="text-[11px] font-semibold text-orange-400 shrink-0">Top Weakness:</span>
